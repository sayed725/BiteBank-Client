    ...
    <ul className="menu menu-horizontal px-1">
      ...
      <div className='navbar-end'>
        <ul className='menu menu-horizontal sm:px-1 font-bold'>
          ...
          {!user && (
            <li className='hidden bg-[#ebb475] text-white hover:text-black sm:block mr-2 rounded-md'>
              <NavLink   to='/login'>Login</NavLink>
            </li>
          )}
          {!user && (
            <li className='bg-[#ebb475] text-white hover:text-black rounded-md' >
            ...
            >
             <li>
              ...
              <li className='mt-2'>
                <button
                  onClick={logOut}
                  className='bg-[#ebb475] btn block text-center'
                >
                  Logout
                </button>
              </li>
